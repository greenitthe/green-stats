module.exports = {
  ...
  // i.e: "-green-stats foo" will trigger the command "foo",
  //      whereas "green-stats foo" will do nothing at all.
  prefix:  "+green-stats",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "Mjg2OTYxMTU4ODgyMDY2NDU0.C5oVYg.q9m226-693KAFyLLcOBmOdtzMew",
